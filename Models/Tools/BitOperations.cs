...
namespace ScortelApi.Tools
{
    public static class BitOperations
    {
        ...
        public static byte[] ShiftLeft(byte[] byteArray)
        {
        ...
        public static byte[] ShiftLeft(byte[] byteArray, int count)
        {

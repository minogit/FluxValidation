...
namespace Validation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            FLUXResponseMessageType resp = new FLUXResponseMessageType();
             
            string filePath = @"D:\Projects\Projects\Fishery\Projects\Api\ScortelApi\Validation\bin\Debug\net5.0\FluxReports\FAReport1.xml";
            ...
            #region read csv
            string fPath = @"D:\Projects\Projects\Fishery\Projects\Api\ScortelApi\Validation\bin\Debug\net5.0\FluxReports\FABRDEF.csv";
            List<FA_MDR_FA_BR_Def> FaBrDef = new List<FA_MDR_FA_BR_Def>();
            StreamReader reader = null;
            if (File.Exists(fPath))
            {
                reader = new StreamReader(File.OpenRead(fPath));
                int count = 0;
            ...
            FLUXFAReportMessageType report = serializer.Deserialize(stringReader) as FLUXFAReportMessageType;
            FLUXFAQueryMessageType faquery = new FLUXFAQueryMessageType();
            FLUXReportVesselInformationType vreport = new FLUXReportVesselInformationType();
            ...
            if (report != null)
            {
                ...
                {
                    IsFRD = true;
                    if (report.FLUXReportDocument.ID != null)
                    {
                        IsFRD_Id = true;
                    }
                    if (report.FLUXReportDocument.CreationDateTime != null)
                    {
                        IsFRD_CreationDT = true;
                    }
                    if (report.FLUXReportDocument.PurposeCode != null)
                    {
                        IsFRD_PCode = true;
                    }
                    if (report.FLUXReportDocument.ReferencedID != null)
                    {
                        IsFRD_RefId = true;
                    }
                    if (report.FLUXReportDocument.OwnerFLUXParty != null)
                    {
                        IsFRD_OFP = true;
                        if (report.FLUXReportDocument.OwnerFLUXParty.ID != null)
                        {
                            IsFRD_OFP_Id = true;
                        }
                    }
            ...
            foreach (var rule in FaBrDef)
            {
                switch (rule.Code)
                {
                    ...
                    case "FA-L00-00-0001":
                        ...
                        if (IsFRD)
                        {
                            if (IsFRD_Id)
                            {
                                ...
                                IDType[] idtype = report.FLUXReportDocument.ID;
                    ...
                    case "FA-L00-00-0005":
                        ...
                        if (IsFRD_CreationDT)
                        {
                            var crdatetime = report.FLUXReportDocument.CreationDateTime;
                    ...
                    case "FA-L00-00-0008":
                        ...
                        if (IsFRD_PCode)
                        {
                            var pcode = report.FLUXReportDocument.PurposeCode;
                    ...
                    case "FA-L00-00-0011":
                        ...
                        if (IsFRD_RefId)
                        {
                            ...
                            var fdocrefid = report.FLUXReportDocument.ReferencedID;
                    ...
                    //case "FA-L03-00-0016":
                        ...
                        if (IsFRD_OFP && IsFRD_OFP_Id)
                        {
                            ...
                            foreach (var ids in report.FLUXReportDocument.OwnerFLUXParty.ID)
                            {                               
                    ...
                    case "FA-L00-00-0020":
                        ...
                        if (IsFARD)
                        {
                            ...
                            foreach (var fardoc in report.FAReportDocument)
                            {

            ...
            foreach (var rule in SalesBrDef)
            {
                ...
                switch (rule.BR)
                {
                    case "SALE-L00-00-0001":
                        ...
                        if (SalesReport != null) 
                        {
                            SalesReportValidate(SalesReport: SalesReport);
                        }
                        else
                        {
                    ...
                    case "SALE-L00-00-0400":
                        ...
                        if (SalesQuery != null) 
                        {
                            SalesQueryValidate(SalesQuery: SalesQuery);
                        }
                        else
                        {
                    ...
                    case "SALE-L00-00-0470":
                        ...
                        {
                            SalesResponseValidate(SalesResponse: SalesResponse);
                        }
                        else
                        {
            ...
            foreach (var rule in SalesBrDef)
            {
                ...
                switch (rule.BR)
                {
                    case "SALE-L00-00-0001":
                        ...
                        if (SalesReport != null)
                        {
                            Console.WriteLine("SalesReport: " + SalesReport);
                            string valuePurposeCode = "";
                            string valueSalesReportTypeCode = "";
                            string valueClassCode = "";
                            string valueUsageCode = "";
